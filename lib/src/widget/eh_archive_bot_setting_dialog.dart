...
class _EHArchiveBotSettingDialogState extends State<EHArchiveBotSettingDialog> {
  ...
  void initState() {
    ...
    _useProxy = widget.botType == ArchiveBotType.ehArBot && widget.useProxy;
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: [
        ...
        TextButton(onPressed: _onConfirm, child: Text('OK'.tr)),
      ],
    );
  }
      ...
      title: DropdownButton<ArchiveBotType>(
        ...
        onChanged: (ArchiveBotType? selected) {
          ...
          setStateSafely(() {
            ...
            if (_botType != ArchiveBotType.ehArBot) {
              _useProxy = false;
            }
          });
        },
  ...
  Widget _buildProxySwitch() {
    return SwitchListTile(
      ...
      value: _useProxy,
      onChanged: _botType == ArchiveBotType.ehArBot
          ? (bool value) {
              setStateSafely(() {
                _useProxy = value;
              });
  ...
  void _onConfirm() {
    final String? address = _apiAddressController.text.isBlank!
        ? null
        : _apiAddressController.text;
    final String? key = _apiKeyController.text.isBlank!
        ? null
